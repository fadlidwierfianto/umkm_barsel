          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Posisi</th>      <td>
                      ...
                      $kota = $this->db->query("SELECT * FROM tb_ro_cities where city_id = 44 ORDER BY city_name ASC");
                    ...
                    <tr><th scope='row'>Tujuan</th>      <td>
                      ...
                      echo "<option value=0>- Pilih Provinsi -</option>";
                      $provinsi2 = $this->db->query("SELECT * FROM tb_ro_provinces WHERE province_aktif = 1 ORDER BY province_name ASC");
                      ...
                      echo "<option value=0>- Pilih Kota / Kabupaten -</option>";
                      $kota2 = $this->db->query("SELECT * FROM tb_ro_cities where city_id = 44 ORDER BY city_name ASC");
