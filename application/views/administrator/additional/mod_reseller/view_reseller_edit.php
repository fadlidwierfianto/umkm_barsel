          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    foreach($provinsi as $p){
                      if($p['province_id'] == $rows[provinsi_id]) {
                        echo "<option value='".$p['province_id']."' selected>'".$p['province_name']."'</option>";
                      }else{
                    ...
                    echo "</select>
                          ...
                          <tr><td><b>Kota</b></td>             
                          <td><select class='form-control form-mini' name='kota_id' id='list_kotakab' required>";
                          $kota = get_kota($rows['provinsi_id']);
                          echo "<option value=0>- Pilih Kota / Kabupaten -</option>";
                          foreach($kabupaten as $k){
                            if($k['city_id'] == $rows[kota_id]) {
                              echo "<option value='".$k['city_id']."' selected>'".$k['city_name']."'</option>";
                            }else{
                    ...
                    foreach($kecamatan as $kec){
                      if($kec['subdistrict_id'] == $rows[kecamatan_id]) {
