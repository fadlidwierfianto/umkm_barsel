              ...
              <div class="box">
                ...
                <?php echo "<div class='col-sm-$kolom col-xs-12'>  "; ?>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'><?= $judul; ?></th>                 <td><?php echo "<a href='".base_url().$this->uri->segment(1)."/detail_konsumen/$rows[id_konsumen]'>$rows[nama_lengkap]</a>"; ?></td></tr>
                ...
                <?php if ($detail['kode_kurir']!='0' AND $detail['kode_kurir']!=''){ ?>
