<div id="homepage-1" style="padding-right: 150px; padding-left: 150px;">

    <div class="ps-home-banner ps-home-banner--1" style="margin-top: 20px;">
            ...
            <div class="ps-section">
                <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
                    ...
                    foreach ($slide1->result_array() as $row) {
                        if ($row['gambar'] == '') {
                            $foto_slide = base_url() . "asset/foto_berita/no-image.jpg";
                        } else {
                            $foto_slide = base_url() . "asset/foto_slide/$row[gambar]";
                        }
    ...
    <div class="row" style="margin-top: 20px;">
        <div class="d-none d-sm-block col-12 col-md-12">
            ...
            <div class="ps-section__content xxx" >
                <div class="ps-carousel--nav owl-slider owl-carousel owl-theme owl-loaded" data-owl-auto="false" data-owl-loop="false" data-owl-speed="10000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="true" data-owl-item="6" data-owl-item-xs="5" data-owl-item-sm="3" data-owl-item-md="4" data-owl-item-lg="5" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">

                    <?php
                    $top_kategori = $this->db->query("SELECT * FROM (SELECT a.*, b.jumlah FROM
                                        (SELECT * FROM rb_kategori_produk) as a LEFT JOIN
                                        (SELECT z.id_kategori_produk, COUNT(*) jumlah FROM rb_penjualan_detail y JOIN rb_produk z ON y.id_produk=z.id_produk GROUP BY z.id_kategori_produk HAVING COUNT(z.id_kategori_produk)) as b on a.id_kategori_produk=b.id_kategori_produk) as x ORDER BY x.jumlah DESC");

                    $counter = 0;
                    foreach ($top_kategori->result_array() as $row) {
                        // Buka div col4 setiap 2 item
                        if ($counter % 2 == 0) {
                            echo '<div class="ps-product ps-product--inner" style="margin-bottom:0px">';
                        }

                        // Tentukan gambar yang akan ditampilkan
                        $gambar_url = base_url() . "asset/foto_produk/icon_kategori/no-image.png";
                        if (!empty($row['icon_image']) && file_exists("asset/foto_produk/icon_kategori/" . $row['icon_image'])) {
                            $gambar_url = base_url() . "asset/foto_produk/icon_kategori/" . $row['icon_image'];
                        }

                        echo '<div class="col4">
                            <a style="margin-top:15px; height:80%" class="ps-block__overlay" href="' . base_url() . 'produk/kategori/' . $row['kategori_seo'] . '">
                                <center><img style="width:55px; height:55px; margin-bottom:3px" src="' . $gambar_url . '"></center>
                                <p style="font-size:13px; line-height:1.1em; color:#000; height:30px; overflow:hidden; text-align:center;">' . $row['nama_kategori'] . '</p>
                            </a>
                          </div>';

                        $counter++;

                        // Tutup div setiap 2 item
                        if ($counter % 2 == 0) {
                            echo '</div>';
                        }
                    }

                    // Tutup div terakhir jika jumlah item ganjil
                    if ($counter % 2 != 0) {
                        echo '</div>';
                    }
                    ?>
                ...
                <a style="margin-top:20px" class="ps-toggle--sidebar btn-custom d-block d-sm-none" href="#navigation-mobile">
                    <i class="icon-list4"></i><span> Tampilkan Semua Kategori</span>
                </a><br>
            </div>
        </div>
    </div>
    ...
    <div class="flash-deals" style="margin-top: 30px;">
        <?php
            ...
            <div class="ps-deal-of-day">
                <div class="ps-container">
                    ...
                    <div class="ps-section__content" style='border:1px solid #cecece; padding:5px 8px'>
                        <div class="ps-carousel--nav owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="20" data-owl-nav="false" data-owl-dots="true" data-owl-item="6" data-owl-item-xs="2" data-owl-item-sm="3" data-owl-item-md="4" data-owl-item-lg="5" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">
                            <?php
        ...
        <?php } else {
            echo "<span style='display:none' id='berakhir'></span>";
        } ?>
    </div>
    ...
    <div class="ps-product-list ps-clothings">
        <div class="ps-container">
            ...
            <div class="ps-section__content">
                <div class="ps-carousel--nav owl-slider" data-owl-auto="false" data-owl-loop="false" data-owl-speed="10000" data-owl-gap="20" data-owl-nav="false" data-owl-dots="true" data-owl-item="6" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">
