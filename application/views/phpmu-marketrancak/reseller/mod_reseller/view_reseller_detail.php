      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 ">
            ...
            $this->session->unset_userdata('message');
              ...
              <div class='form-group row' style='margin-bottom:5px'>
              <label class='col-sm-3 col-form-label' style='margin-bottom:1px'>Rekening Bank Toko</b></label>
                <div class='col-sm-9'>
                  <div class='row'>
                    <div class='col'>
                      Nama Bank : $rows[nama_bank]
                    </div>
                    <div class='col'>
                      No Rek : $rows[norek_bank]
                    </div>
                    <div class='col'>
                      Pemilik : $rows[an_bank]
                    </div>
                  </div>
                </div>
              </div>
