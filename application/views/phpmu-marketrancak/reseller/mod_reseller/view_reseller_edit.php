        ...
        <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 ">
            ...
            <?php 
              ...
              <div class='col-sm-9'>
                <div class='row'>
                  <div class='col'>
                    <input type='text' name='nama_bank' class='form-control form-mini' value='$rows[nama_bank]' placeholder='Nama Bank'>
                  </div>
                  <div class='col'>
                    <input type='text' name='norek_bank' class='form-control form-mini' value='$rows[norek_bank]' placeholder='No Rekening'>
                  </div>
                  <div class='col'>
                    <input type='text' name='an_bank' class='form-control form-mini' value='$rows[an_bank]' placeholder='Nama Pemilik'>
                  </div>
                </div>
              </div>
              </div>
