    ...
    <div class="container">
        <div class="ps-section__header">
            ...
            <?php if ($rows['kode_transaksi']==''){
                ...
                echo "<p>Untuk Melakukan konfirmasi pesanan Anda, masukkan No Pesanan Anda di kotak di bawah ini dan tekan tombol ''Submit''. Kode Ini diberikan kepada Anda pada saat anda menerima detail pesanan dalam email konfirmasi.</p>";
                ...
                echo "<p>Untuk Melakukan konfirmasi pesanan Anda ''$kode'', Silahkan untuk memasukkan Bukti transfer yang telah anda lakukan pada form dibawah ini.</p>";
              } 
            ?>
          </div>
