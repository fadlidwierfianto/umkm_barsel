            ...
            <div class='table-responsive'>
                <table class="table table-sm iconset">
                  <tbody>
                    ...
                    <tr><th scope='row'><b><?= $judul; ?></b></th>                 <td><?php echo "<a href='".base_url().$this->uri->segment(1)."/detail_konsumen/$rows[id_konsumen]'>$rows[nama_lengkap]</a> <i style='color:red'>(Hp : $rows[no_hp])</i>"; ?></td></tr>
