                            ...
                            <div class='col-sm-9'>
                              <div class='row'>
                                ...
                                <div class='col'>
                                  ...
                                  $kota = $this->db->query("SELECT * FROM tb_ro_cities where province_id='$row[provinsi_id]' AND province_id = 14 ORDER BY city_name ASC");
                                ...
                                <div class='col'>
                                  ...
                                  echo "<option value=0>- Pilih Kecamatan -</option>";
                                    $subdistrict = $this->db->query("SELECT * FROM tb_ro_subdistricts where city_id='$row[kota_id]' AND city_id = 44 ORDER BY subdistrict_name ASC");
