...
class Administrator extends CI_Controller {
    ...
    function edit_reseller(){
        ...
        if (isset($_POST['submit'])){
            ...
            $data['provinsi'] = $this->mm->get('tb_ro_provinces',array('where'=>array('province_aktif'=>1)));
            $data['kabupaten'] = $this->mm->get('tb_ro_cities',array('where'=>array('province_id'=>14,'city_id'=>44)));
            $data['kecamatan'] = $this->mm->get('tb_ro_subdistricts',array('where'=>array('city_id'=>44)));
...
public function upload(){
    ...
    function pembayaran_konsumen(){
        ...
        $data['record'] = $this->db->query("SELECT a.*, b.*, c.id_penjualan, c.kode_transaksi, c.proses FROM `rb_konfirmasi_pembayaran_konsumen` a JOIN rb_rekening_reseller b ON a.id_rekening_reseller=b.id_rekening_reseller JOIN rb_penjualan c ON a.kode_transaksi=c.kode_transaksi where c.status_penjual='reseller' GROUP BY c.kode_transaksi ORDER BY a.id_konfirmasi_pembayaran DESC");
