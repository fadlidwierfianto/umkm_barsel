...
class Main extends CI_Controller {
	public function email(){
		echo kirim_email('Coba Kirimkan Email','Ini adalah isi Pesan yang dikirim...','setda@baritoselatankab.go.id');
	...
	public function theme(){
		$theme = array("red", "green", "blue", "orange", "yellow", "white"."custom");
