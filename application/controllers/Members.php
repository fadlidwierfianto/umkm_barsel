...
The code will expire in 10 minutes, If you have not tried to login, ignore this message.";
		...
		if (isset($_POST['submit'])){
            ...
            if ($hasil['file_name']==''){
		           $data = array('nama_reseller'=>cetak($this->input->post('c')),
							...
							'nama_bank'=>cetak($this->input->post('nama_bank')),
							'norek_bank'=>cetak($this->input->post('norek_bank')),
							'an_bank'=>cetak($this->input->post('an_bank')),
			...
			$data2 = array(
				'nama_bank' =>cetak($this->input->post('nama_bank')),
				'no_rekening' =>cetak($this->input->post('norek_bank')),
				'pemilik_rekening'=>cetak($this->input->post('an_bank')),
			);
			$this->mm->save('rb_rekening_reseller',$data2,array('where'=>array('id_reseller'=>reseller($this->session->id_konsumen))));
	...
	function buat_toko(){
		...
		if (isset($_POST['submit'])){
			...
			$idtoko = $this->model_app->insert('rb_reseller',$data);
			$data2 = array(
				'id_reseller'=>$idtoko,
				'nama_bank' => cetak($this->input->post('nama_bank')),
				'no_rekening' => cetak($this->input->post('norek_bank')),
			...
			$simpan_rek_reseller = $this->mm->save('rb_rekening_reseller',$data2);
			redirect($this->uri->segment(1).'/profil_toko');
		}else{
