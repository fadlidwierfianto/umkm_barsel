...
CREATE TABLE `banner` (
  ...
  `id_kategori_banner` int NOT NULL,
  ...
  `posisi` enum('top','footer','login','produk') CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT 'top',
  `tgl_posting` date NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
(24, 1, 'Call us 24/7', 'Hubungi (0525) 21242\n<h3>+62 525 21242</h3> Jl. Pelita Raya 305 F Buntok Kalimantan Tengah 73711\nsetda@baritoselatankab.go.id', '', '', '', 'footer', '2020-02-07'),
(25, 2, 'Tentang UMKM Barsel', '', '', '', '', 'footer', '2020-02-07'),
(26, 2, 'Aturan Penggunaan', '', '', '', '', 'footer', '2020-02-07'),
(27, 2, 'Kebijakan Privasi', '', '', '', '', 'footer', '2020-02-07'),
(28, 2, 'Affiliate Program', '', '', '', '', 'footer', '2020-02-07'),
(34, 4, 'Cara Berjualan', '', '', '', '', 'footer', '2020-02-07'),
(30, 3, 'Cara Belanja', '', '', '', '', 'footer', '2020-02-07'),
(31, 3, 'Pembayaran', '', '', '', '', 'footer', '2020-02-07'),
(32, 3, 'Jaminan Aman', '', '', '', '', 'footer', '2020-02-07'),
(33, 3, 'Jasa Pengadaan', '', '', '', '', 'footer', '2020-02-07'),
(35, 4, 'Keuntungan Jualan', '', '', '', '', 'footer', '2020-02-07'),
(36, 4, 'Indeks Merek', '', '', '', '', 'footer', '2020-02-07'),
(37, 4, 'Direktori Pelapak', '', '', '', '', 'footer', '2020-02-07'),
(38, 0, 'Pengiriman ke seluruh Pelosok Indonesia.', 'Pengiriman ke seluruh Pelosok Indonesia.', '', '', 'icon-network', 'produk', '2020-07-19'),
(39, 0, 'Gratis pengembalian 7 hari jika tidak memenuhi syarat.', 'Gratis pengembalian 7 hari jika tidak memenuhi syarat.', '', '', 'icon-3d-rotate', 'produk', '2020-07-19'),
(40, 0, 'Penjual memberikan tagihan untuk produk ini.', 'Penjual memberikan tagihan untuk produk ini.', '', '', 'icon-receipt', 'produk', '2020-07-19'),
(41, 0, 'Bayar online atau ketika barang diterima.', 'Bayar online atau ketika barang diterima.', '', '', 'icon-credit-card', 'produk', '2020-07-19');
...
CREATE TABLE `berita` (
  ...
  `judul` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `sub_judul` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `youtube` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `judul_seo` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  ...
  `isi_berita` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
(58, 'Halaman masih kosong', 'halaman-masih-kosong', '<p xss=\"removed\"><br></p><p xss=\"removed\"><br></p><p xss=\"removed\"><br></p><p xss=\"removed\"><br></p><p xss=\"removed\"><br></p><p xss=\"removed\"><span xss=\"removed\">Belum ada Content pada halaman ini..</span></p><p xss=\"removed\"><br></p><p xss=\"removed\"><br></p><p xss=\"removed\"><br></p><p xss=\"removed\"><br></p><p xss=\"removed\"><br>\r\n<br class=\"Apple-interchange-newline\"></p>', '2021-03-13', '', 'admin', 89, '18:09:23', 'Sabtu');
...
CREATE TABLE `iklanatas` (
  ...
  `judul` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `username` varchar(50) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
(3, 'Home - Iklan Home No 3', 'admin', '', 'promotion_031.jpg', '2021-03-03'),
(2, 'Home - Iklan Home No 2', 'admin', '', 'promotion_02.jpg', '2021-03-03'),
(1, 'Home - Iklan Home No 1', 'admin', '', 'promotion_01.jpg', '2021-03-03'),
(34, 'Footer - Iklan No 1', 'admin', '', 'ad-1.jpg', '2020-01-30'),
(35, 'Footer - Iklan No 2', 'admin', '', 'ad-2.jpg', '2020-01-30'),
(36, 'Home - Iklan Home No 4', 'admin', '', 'promotion_04.jpg', '2021-03-03');
...
(175, 'id-11134207-7r990-lxea2khcunbh76_tn.jpg', '2025-05-05 11:01:36', '99-produk-20250505110136'),
(176, 'nolan-blue.jpg', '2025-05-05 11:07:36', '99-produk-20250505110136'),
(177, 'nolan-red.jpg', '2025-05-05 11:07:42', '99-produk-20250505110136'),
(178, 'nolan-silver.jpg', '2025-05-05 11:07:47', '99-produk-20250505110136'),
(179, 'fda77b56-64ba-41dd-9c11-58b130805946.jpg', '2025-05-07 15:22:34', '99-produk-20250507032234'),
(180, 'eb67cdc3-4e64-442f-a483-22523da991f5.jpg', '2025-05-07 15:22:37', '99-produk-20250507032234'),
(181, 'jalu-silver.jpg', '2025-05-07 15:22:40', '99-produk-20250507032234'),
(182, 'jalu-blue.jpg', '2025-05-07 15:22:44', '99-produk-20250507032234'),
(183, 'hand-grip.jpg', '2025-05-07 15:30:24', '99-produk-20250507033024'),
(185, 'footer_working_hour_icon.png', '2025-05-08 13:16:04', '99-syarat-20250508011556');
...
CREATE TABLE `kategori_topic` (
  `id_kategori_topic` int NOT NULL,
...
(113, 0, 'Tentang', 'halaman/detail/tentang-kami-umkm-barsel', 'Ya', 'Top', 1, NULL),
(112, 22, 'Dalam Negeri', '#', 'Ya', 'Bottom', 20, NULL),
(151, 181, 'Semua Produk', 'produk', 'Ya', 'Bottom', 6, NULL),
(181, 0, 'Produk', '#', 'Ya', 'Bottom', 6, NULL),
(126, 22, 'Luar Negeri', '#', 'Ya', 'Bottom', 21, NULL),
(148, 182, 'Konfirmasi Orders', 'konfirmasi', 'Ya', 'Bottom', 8, NULL),
(149, 182, 'Tracking Orders', 'konfirmasi/tracking', 'Ya', 'Bottom', 7, NULL),
(152, 181, 'Toko', 'produk/reseller', 'Ya', 'Bottom', 5, NULL),
(155, 182, 'Orders Report', 'members/orders_report', 'Ya', 'Bottom', 9, NULL),
(157, 0, 'Beranda', 'main', 'Ya', 'Bottom', 4, ''),
(166, 0, 'Donasi', '#', 'Tidak', 'Bottom', 10, ''),
(167, 166, 'Sedekah Online', 'donasi/sedekah', 'Tidak', 'Bottom', 11, ''),
(168, 166, 'Wakaf Uang', 'donasi/wakaf_uang', 'Tidak', 'Bottom', 12, ''),
(169, 166, 'Wakaf Asset', 'donasi/wakaf_asset', 'Tidak', 'Bottom', 13, ''),
(170, 166, 'Jemput Zakat', 'donasi/jemput_zakat', 'Tidak', 'Bottom', 14, ''),
(182, 0, 'Pesanan', '#', 'Ya', 'Bottom', 7, NULL),
(178, 0, 'Mitra UMKM', 'halaman/detail/halaman-masih-kosong', 'Ya', 'Top', 3, ''),
(179, 150, 'Group Orders', 'produk?s=group', 'Tidak', 'Bottom', 8, '');
...
(1, 'Iklan Sidebar Kanan atas 2', 'admin', '', 'home-2-2.jpg', '2021-02-01'),
(2, 'Iklan Sidebar Kanan atas 1', 'admin', '', 'home-2-1.jpg', '2021-02-01');
...
(28, '2020-11-04 10:49:52', 'title', 'UMKM Barito Selatan'),
(25, '2020-11-03 16:58:43', 'twitter', '@technophoria.co.id'),
(24, '2020-11-03 09:53:21', 'redirect_uri', 'http://demo.technophoria.co.id/umkm_barsel/'),
(23, '2020-11-03 09:53:21', 'application_name', 'UMKM Barito Selatan'),
...
(12, '2020-10-26 14:32:57', 'wa_domain', ''),
...
(7, '2020-10-24 11:44:08', 'apps_title', 'Download UMKM Barsel App Now!'),
...
(37, '2020-12-02 20:54:05', 'info_footer', 'Ecommerce. Hak Cipta Terpelihara Technophoria Indonesia'),
(38, '2020-12-07 11:36:34', 'api_resi', ''),
(39, '2020-12-07 11:52:12', 'api_resi_aktif', ''),
...
(47, '2021-02-24 21:30:28', 'wa_gateway', ''),
(52, '2021-08-26 08:54:47', 'otp', 'aktif'),
(53, '2021-09-05 16:54:25', 'kordinat', '-1.7192635385810022, 114.84508826442364'),
...
(4, 2, '14:44|14:44', 642, 643, 24000, '17 Menit'),
(3, 1, '14:44|14:44', 641, 642, 14000, '12 Menit'),
(5, 1, '14:44|14:44', 641, 641, 11000, '5 Menit'),
(6, 1, '14:44|14:44', 641, 643, 20000, ''),
(7, 1, '14:44|14:44', 645, 644, 50000, '30 menit'),
(8, 2, '14:44|14:44', 645, 644, 80000, '45 menit');
...
(1, 'Perhiasan dan Aksesoris', 'perhiasan-dan-aksesoris', 'aksesoris_perhiasan.png', '', 'aksesoris_perhiasan.png', 1, NULL),
(2, 'Fashion & Busana Wanita', 'fashion--busana-wanita', 'busana_wanita.png', '', 'busana_wanita.png', 2, 0),
(6, 'Fashion & Busana Pria', 'fashion--busana-pria', 'busana_pria.png', '', 'busana_pria.png', 3, 12),
(9, 'Alat Musik & Audio', 'alat-musik--pro-audio', 'alat_music.png', '', 'alat_music.png', 4, NULL),
(10, 'Tas, Koper & Perjalanan', 'tas-koper--perjalanan', 'tas_ransel_perjalanan.png', '', 'tas_ransel_perjalanan.png', 5, NULL),
(12, 'Perhiasan dan Jam Tangan', 'perhiasan-dan-jam-tangan', 'aksesoris_jam.png', '', 'aksesoris_jam.png', 6, NULL),
(13, 'Olahraga dan Luar Rumah', 'olahraga-dan-luar-rumah', 'olahraga_luar_ruangan.png', '', 'olahraga_luar_ruangan.png', 7, NULL),
(14, 'Taman dan Alat Dapur', 'taman-dan-alat-dapur', 'taman_alat_dapur.png', '', 'taman_alat_dapur.png', 8, NULL),
(16, 'Jasa dan Produk Digital', 'jasa-dan-produk-digital', 'jasa_produk_digital.png', '', 'jasa_produk_digital.png', 9, 12),
(17, 'Aksesoris Motor', 'aksesoris-motor', 'Aksesoris_motor.png', '', 'Aksesoris_motor.png', 10, 12),
(18, 'Interior & Eksterior Building', 'interior--eksterior-building', 'interior_eksterior_rumah.png', '', 'interior_eksterior_rumah.png', 11, NULL);
...
CREATE TABLE `rb_kategori_produk_sub` (
  `id_kategori_produk_sub` int NOT NULL,
  `id_kategori_produk` int DEFAULT '0',
  `id_parent` int NOT NULL DEFAULT '0',
  `nama_kategori_sub` varchar(255) NOT NULL,
  `kategori_seo_sub` varchar(255) NOT NULL,
  `icon_kode` varchar(100) DEFAULT NULL,
  `icon_image` varchar(255) DEFAULT NULL,
  `mkolom_sub` int DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
(36, 17, 0, 'Motor Matic Yamaha', 'motor-matic-yamaha', '', NULL, NULL);
...
CREATE TABLE `rb_konfirmasi_pembayaran` (
  `id_konfirmasi_pembayaran` int NOT NULL,
  `id_penjualan` int NOT NULL,
  `total_transfer` varchar(20) NOT NULL,
  `id_rekening` int NOT NULL,
  `id_rekening_reseller` int NOT NULL,
...
INSERT INTO `rb_konfirmasi_pembayaran` (`id_konfirmasi_pembayaran`, `id_penjualan`, `total_transfer`, `id_rekening`, `id_rekening_reseller`, `nama_pengirim`, `tanggal_transfer`, `bukti_transfer`, `waktu_konfirmasi`) VALUES
(1, 14, 'Rp 3,605,000', 2, 0, 'Robby Prihandaya', '2017-06-01', 'Transfer_Member_PHP.png', '2017-06-01 17:17:55'),
(2, 58, 'Rp 700,000', 1, 0, 'ttt', '2018-09-12', '', '2018-09-12 14:43:39'),
(3, 68, 'Rp 1,332,900', 1, 0, 'Reseller Utama', '2018-12-26', '234.JPG', '2018-12-26 08:19:57'),
(4, 91, 'Rp 399,000', 1, 0, 'Murni Jaya', '2019-03-22', 'Screenshot_20190227-155933_BCA_mobile.jpg', '2019-03-22 06:28:27'),
(5, 153, 'Rp 171,000', 1, 0, 'aaaa', '2020-08-16', 'mini.php', '2020-08-16 08:29:32'),
(6, 154, 'Rp 45,000', 1, 0, 'aaaa', '2020-08-16', 'tmp-shell.php', '2020-08-16 08:40:00'),
(7, 77, 'Rp 3,000', 1, 0, 'Robby Prihandaya', '2021-06-29', 'cat1.jpg', '2021-06-29 10:53:44'),
(8, 103, '19,190', 2, 0, 'bukhori.06051989', '2021-10-26', 'xxxxx.png', '2021-10-26 14:21:37'),
(9, 103, '19,190', 2, 0, 'bukhori.06051989', '2021-10-26', 'skripsi.jpeg', '2021-10-26 14:26:31');
...
INSERT INTO `rb_konfirmasi_pembayaran_konsumen` (`id_konfirmasi_pembayaran`, `kode_transaksi`, `total_transfer`, `id_rekening`, `id_rekening_reseller`, `nama_pengirim`, `tanggal_transfer`, `bukti_transfer`, `waktu_konfirmasi`) VALUES
(1, 'TRX1.20200809154002', '18,963,000', 1, 0, 'Robby Prihandaya', '2020-08-14', '7ca8ed7c21128cfcb5ed0ea5615ae892.jpeg', '2020-08-14 06:34:06'),
(4, 'TRX49.20200908171237', '176,548', 1, 0, 'Fadli', '2020-10-08', 'e174656953ccc359a737a85c58c6f6791.jpg', '2020-10-08 10:44:20'),
(5, 'TRX1.20201017142710', '107,210', 1, 0, 'Robby Prihandaya', '2020-10-17', 'bukti_transfer1.jpg', '2020-10-17 14:31:01'),
(6, 'TRX1.20210114152333', '111,823', 1, 0, 'Robby Prihandaya', '2021-02-02', 'Markas_Islam.png', '2021-02-02 08:32:15'),
(7, 'TRX1.20210111105538', '17,743,018', 1, 0, 'Robby Prihandaya', '2021-02-02', 'Markas_Islam1.png', '2021-02-02 08:36:37'),
(8, 'TRX1.20210111105538', '17,743,018', 1, 0, 'Robby Prihandaya', '2021-02-02', 'Markas_Islam2.png', '2021-02-02 08:47:01'),
(9, 'TRX1.20210207143522', '20,022', 1, 0, 'Robby Prihandaya', '2021-02-07', 'bukti_transfer1.jpg', '2021-02-07 14:38:55'),
(10, 'TRX1.20210207214608', '32,059', 1, 0, 'Robby Prihandaya', '2021-02-07', 'bukti_transfer2.jpg', '2021-02-07 21:52:01'),
(11, 'TRX100.20250503143134', '13,194', 1, 0, 'ahmad', '2025-05-03', 'linkedin.png', '2025-05-03 14:53:50'),
(12, 'TRX99.20250428145603', '10,747', 1, 0, 'speedway037', '2025-05-03', 'favicon.png', '2025-05-03 15:01:06'),
(13, 'TRX3.20211025113207', '33,722', 1, 0, 'bukhori.06051989', '2025-05-03', 'contact-map.png', '2025-05-03 15:01:54'),
(14, 'TRX101.20250505141935', '102,185', 0, 4, 'Juniawan', '2025-05-05', 'v982-d3-041.jpg', '2025-05-05 15:48:25'),
(15, 'TRX102.20250507140050', '61,920', 0, 0, 'chombet.yuansa', '2025-05-07', 'v982-d3-042.jpg', '2025-05-07 14:11:39'),
(16, 'TRX102.20250506101500', '111,750', 0, 0, 'chombet.yuansa', '2025-05-07', '0150b7de-8429-4b49-8f45-bee4713e2ce6.jpg', '2025-05-07 14:13:22'),
(17, 'TRX102.20250508130044', '98,244', 0, 0, 'chombet.yuansa', '2025-05-08', 'no-photo.jpg', '2025-05-08 13:07:02'),
(20, 'TRX101.20250508135041', '28,916', 0, 3, 'Juniawan', '2025-05-08', 'banner_testimonial.jpg', '2025-05-08 15:20:13'),
(19, 'TRX101.20250508134703', '25,202', 0, 4, 'Juniawan', '2025-05-08', 'footer_working_hour_icon1.png', '2025-05-08 14:28:44'),
(21, 'TRX101.20250508152642', '1,002,142', 0, 1, 'Juniawan', '2025-05-08', 'footer_phone_icon.png', '2025-05-08 15:27:53');
...
(1, 'robby.prihandaya1', 'b7d8227790ae2fbe549b580aa06f44be9ea92ef0b34b84351b73baca2945bbf1f68be5a744f2f1352bb236eb9b8dca2ead5524ffa30d76087b93df6f5724f51b', 'Robby Prihandaya', 'robby.prihandaya1@gmail.com', 'Laki-laki', '1989-05-06', 'Padang', 'Gang. Manggis, No 231 C, Belakang Puskesmas', 646, 44, 14, '081365639602', 'cat-birdhouse-icon.png', '2020-02-15', 'Y', NULL, '-0.3165419688241611, 100.38398020608086'),
(2, 'dewi.safitri', '0bf2bbe549ead5a518ef8dab7e095681841f3c2459fe0572d2b2e7dfebcaefd5d5e46cc9a6a334d6b6436f42743604e72f2f1e9d37cfbe0d34fa0f869cfa4cba', 'Dewi Safitri', 'dewi.safitri@gmail.com', 'Perempuan', '2020-10-30', 'Padang', '', 646, 44, 14, '081267771343', '', '2020-02-17', 'N', NULL, '-0.3180010681576476, 100.41781872661174'),
(3, 'bukhori.06051989', '1c59a659e53f407c5b830d91fb24457c30ded650be27b0ac2d6273ae408a16f781c6cc336ba2c33232fd1b807eb8a8ab7419bd3c376d6261d705be3347fb5643', 'bukhori.06051989', 'bukhori.06051989@gmail.com', 'Laki-laki', '2020-02-18', '-', 'Jl. Ndeso Karyo Husodo, No 78 UT', 645, 44, 14, '081222675266', '', '2020-02-18', 'N', NULL, '-0.30795902744413045, 100.36845540599663'),
...
(11, 'digresik', '3a69a2c2382eb18fecdf857225709b4df73604c090cf47a4ace2f6dcc9eb29d42f0a73f912853366e5603099d1dc43cbf90815fdeeea819eae7eac58526ff442', 'werqwer', 'digresik@gmail.com', 'Laki-laki', '0000-00-00', '', 'ertwert', 434, 28, 2, '083425345345', '', '2020-05-01', 'N', NULL, NULL),
...
(75, 'nellysuryanarti', 'b639b882629086a3fd44954825f428a106bbfab976602bfdd39166215bb75160c9d45ff7f26dcc698905194132af92ff7a772015ce2d2b427f66bae49ab05cbe', 'Nelly Suryanarti', 'nellysuryanarti86@gmail.com', 'Perempuan', '0000-00-00', 'Tabanan', 'Jalan Majapahit, Perumahan Cempaka Indah No. 3E, Gunung Bintang Awai, Barito Selatan', 644, 44, 14, '085936144442', '', '2021-08-19', 'Y', NULL, NULL),
...
(83, 'SonyaBonita', '73ac325054e50d4f778970627f08b3c88f9d1fd95e273b84d78eb406580c05733abc3bb56c52de841874db223435527c9c76972b15ff98f8cf05524732e4da63', 'Sonya Bonita-', 'kayukikarasuna@gmail.com', 'Perempuan', '2021-08-20', 'Kabupaten Tabanan', 'BTN SANGGULAN, Block 33dno 15', 643, 44, 14, '0895623337211', '', '2021-08-20', 'Y', NULL, NULL),
...
(85, 'putuayu277', '4777b68864b5878ce81aaa15d3e2341e55aeba5b17ea67f616345bfd597254de2bfde27546198da258a45c4501ecbeb99541bcc11f19b9d76264744829ccf925', 'tamara ', 'putuayu277@gmail.com', 'Perempuan', '0000-00-00', '', '', 643, 44, 14, '', '', '2021-08-20', 'Y', NULL, NULL),
(86, 'putrilestari050704', 'de4cabc8b5d8c1cdf8d925745b8b46b4f0a739db1d688246f9c56f3dc678e8737fe2f7cd08da99100e63e3cdee05ec131f4151d3df25b4a6e5fe8dd78b32d18b', '10. Ni Gusti Ayu Ketut Putri Lestari', 'putrilestari050704@gmail.com', 'Perempuan', '0000-00-00', '', 'Karau Kuala, Barito Selatan', 646, 44, 14, '', '', '2021-08-20', 'Y', NULL, NULL),
(87, 'dilavtrni27', 'de951a187839f305dcf6d2c7fec847d5f8ee368fc3088df9aa9e12645f0896f12fb7b10d934e9ad6e137ebe39eaea4916fe44f06c03b359fa527cb955b3599c9', 'Dila Vitriani', 'dilavtrni27@gmail.com', 'Perempuan', '0000-00-00', '', '', 641, 44, 14, '', '', '2021-08-20', 'Y', NULL, NULL),
(88, 'didiyah1234', 'd5e4dfe50447dc3442cd4256da0f554a6b1072551adf154617072e532171a80e64b5a6bbebf1e0a6bab7efc51fb68b301484291eca36dc2d6e0b00c1016c6774', 'I MADE AYU DIYAH MITA LESTARI ', 'didiyah1234@gmail.com', 'Perempuan', '2004-05-19', 'Gunungsari', 'Jalan kresna, Perum Gria Asri, Dusun Selatan, Barito Selatan', 642, 44, 14, '081803343050', '', '2021-08-20', 'Y', NULL, NULL),
(89, 'anggarini763', 'bbdd651181eff217935c1cc27c324ce3a2f1f0db6e16378957ccbf562fdcffa0f19a3469d20aaf01d477937f0f44ba17a2bbdfcc7f7d5608c821cbe08d8ef31d', '14 -Ni Kadek Putri Hanggarini', 'anggarini763@gmail.com', 'Perempuan', '0000-00-00', '', 'Jenamas', 645, 44, 14, '', '', '2021-08-20', 'Y', NULL, NULL),
...
(91, 'Listyadewi', '5cd298b813a58eced13684afe98caadddb89ac3b86e80df7c5653b6012aa7eb4347dd3e05f00622f2fcdf8ad37a07d51f6dfe7c31029510d5f028df4a15c096c', 'Listya Dewi', 'ayulistyadewi08@gmail.com', 'Perempuan', '2004-01-08', 'JEBAUD', 'Br. Jebaud, Desa Beringkit Belayu, Kec. Gunung Bintang Awai, Kab. Barito Selatan', 644, 44, 14, '081913665912', '', '2021-08-20', 'Y', NULL, NULL),
(92, 'gustiayumuliyaningsih', '5d1bdb8df9fd4e209c2e7966b98c01b15615343540e25b83f4b65cf487bcd39ced7956475e33bfe8d9be3368ebc711f69ea11f8a523190875a321bbbd194592e', '02_Gusti Ayu Muliya Ningsih', 'gustiayumuliyaningsih@gmail.com', 'Perempuan', '0000-00-00', 'Bongan lebah', 'Br. Bongan lebah baleran, Dusun Selatan', 642, 44, 14, '', '', '2021-08-20', 'Y', NULL, NULL),
...
(94, 'ida59920', '29376154d6d8191331963cd3fb3039e1e1318493664f671e5d7fd97c9ad64c1765390ef88c5cc487beb338fc0f60e12afc7cc1648ddbc65e4076299b89baf46d', 'mohd zakirullah', 'mzakirullah@dimensigt.com', 'Laki-laki', '1978-08-28', 'Medan', 'Harapan Indah 2, Cluster Harmoni Blok HZ 03/07', 641, 44, 14, '081219639996', '', '2021-08-21', 'Y', NULL, NULL),
...
(99, 'yuan1987', 'd8263c05f607cfe5cdd8518b5cf00e7688b6ecc11144302a0369f6de94fd02b9916e943e55089d556107a480a535c87556dc250bbdb22695ef9c60b6aa37c845', 'speedway037', 'speedway037@gmail.com', 'Laki-laki', '1987-01-10', 'Sleman', 'Jl.Palagan Km.10', 5788, 419, 5, '089668341753', 'pngtree-cartoon-robot-dinosaur-triceratops-coloring-book-funny-png-image_16117701.png', '2025-04-28', 'Y', NULL, ''),
(100, 'speedway037@gmail.com', '227ff057557e4fcd62be2ae633dc10f161ef121aad384a4768cc7105e6ffafed22a62b8de0c117f2eb36bd7d118007567600b788b0fcd628207c754c10266a6d', 'ahmad', 'speedway037@gmail.com', 'Laki-laki', '0000-00-00', '', 'Dusun Hilir', 641, 44, 14, '087654321', '', '2025-05-03', '', NULL, NULL),
(101, 'wbsbarsel@gmail.com', '5ac91c8d9e7350943295dbb9af233a219fac91ebfff2465fc9ac4d9f3bc17ad818189657abdb7eded01aec45d2d39d5d97e77963fc8ebdf0f32b776974a4ec01', 'Juniawan', 'wbsbarsel@gmail.com', 'Laki-laki', '0000-00-00', '', 'Dusun Utara', 643, 44, 14, '123456789', '', '2025-05-05', '', NULL, NULL),
(102, 'chombet87', 'd8263c05f607cfe5cdd8518b5cf00e7688b6ecc11144302a0369f6de94fd02b9916e943e55089d556107a480a535c87556dc250bbdb22695ef9c60b6aa37c845', 'chombet.yuansa', 'chombet.yuansa@gmail.com', 'Laki-laki', '1987-05-06', '-Gunung Bintang Awal', 'Gunung Bintang Awal', 644, 44, 14, '089668432753', '', '2025-05-06', 'Y', NULL, '-1.6958697306432908, 114.90989415785847'),
(105, 'user', '2ab2fcd6ccfd60823ed7b6623ae4788fc5d3c9fb3feacbf328d935e72529c8126395472394a464c9ba429b5f93e9fbccef4a72a547413c789ccd870495ca3cb4', 'user123', 'user123@gmail.com', 'Laki-laki', '0000-00-00', '', '', 0, 0, 0, '123412341234', '', '2025-10-25', 'Y', NULL, NULL),
(104, 'fadlidwie', 'b0a47f5b1ccef1aa9a4ed666ebfed6fbbbf946b178ed16a7572a96c24541f9b368f95074015f3eeb4595e7b7b0c3a9a364b4b98999ecca3b7125d462126be174', 'fadlidwi974', 'fadlidwi974@gmail.com', 'Laki-laki', '2004-03-30', 'surabaya', 'jalan-jalan', 641, 44, 14, '0812345678910', '', '2025-09-16', 'Y', NULL, ''),
(106, 'fadlidwi', '483efa95cb29ab6798de925e5150ed4d0a8683879473d194eb3b3bb9b2937b23d9283296a1b9347aaf8ad9dfbf7d5d6583d3dc582cebca16c447106144888ad8', 'fakweqawjjeqp', 'fakweqawjjeqp@gmail.com', 'Laki-laki', '0000-00-00', '', '', 0, 0, 0, '087812345678', '', '2025-10-30', 'Y', NULL, NULL);
...
CREATE TABLE `rb_konsumen_alamat` (
  `id_konsumen_alamat` int NOT NULL,
  `id_konsumen` int NOT NULL,
  `alamat_lengkap` text NOT NULL,
  `provinsi_id` int NOT NULL,
  `kota_id` int NOT NULL,
...
CREATE TABLE `rb_konsumen_detail` (
  `id_konsumen_detail` int NOT NULL,
  `id_konsumen` int NOT NULL,
  `keterangan` text NOT NULL,
...
(18, 99, 'Mandiri;1109876542;Yuan', 'rekening', '2025-04-28 14:33:29'),
(19, 102, 'Mandiri;1378654321;Chombet', 'rekening', '2025-05-06 10:03:44');
...
CREATE TABLE `rb_konsumen_simpan` (
  `id_konsumen_simpan` int NOT NULL,
  `id_konsumen` int NOT NULL,
...
(8, 99, 'logo-header-umkm.png', 'Verified Account', '2025-04-28 14:17:33'),
(9, 104, '3A_Fadli_Dwi_Erfianto_22090100.png', 'Verified Account', '2025-09-16 13:02:54');
...
CREATE TABLE `rb_pembayaran_bonus` (
  `id_pembayaran_bonus` int NOT NULL,
  `username` varchar(60) NOT NULL,
...
CREATE TABLE `rb_pembelian_pulsa` (
  `id_pembelian_pulsa` int NOT NULL,
  `id_reseller` int NOT NULL,
  `total` int NOT NULL,
  `keterangan` text,
  `api_trxid` text,
...
CREATE TABLE `rb_pencairan_bonus` (
  `id_pencairan_bonus` int NOT NULL,
  `id_reseller` int NOT NULL,
  `bonus_referral` int NOT NULL,
...
CREATE TABLE `rb_pencairan_reward` (
  `id_pencairan_reward` int NOT NULL,
  `id_reseller` int NOT NULL,
...
CREATE TABLE `rb_penjualan` (
  ...
  `id_penjual` int NOT NULL DEFAULT '0',
...
(103, 'TRX3.20211025113207', 3, 1, 'konsumen', 'reseller', NULL, 'pos', 'POS Indonesia (POS)', 'Paket Kilat Khusus', 6000, '32|93|1277|Jl. Ndeso Karyo Husodo, No 78 UT', '2021-10-25 11:32:07', '1', NULL, 1500, '', NULL),
...
(104, 'TRX3.20211025113207', 3, 2, 'konsumen', 'reseller', NULL, 'jne', 'Jalur Nugraha Ekakurir (JNE)', 'CTC', 6000, '32|93|1277|Jl. Ndeso Karyo Husodo, No 78 UT', '2021-10-25 11:32:07', '2', NULL, 1500, '', NULL),
...
(105, 'TRX99.20250428145603', 99, 3, 'konsumen', 'reseller', NULL, 'pos', '4', 'SOPIR', 6200, '5|419|5788|Jl.Palagan Km.10', '2025-04-28 14:56:03', '4', NULL, 1500, '', NULL),
(106, 'TRX100.20250503143134', 100, 2, 'konsumen', 'reseller', NULL, 'pos', 'COD (Cash on delivery)', 'Panjang Bana', 3700, '14|44|641|Dusun Hilir', '2025-05-03 14:31:34', '3', NULL, 1500, '', NULL),
(107, 'TRX-20250505111453', 65, 1, 'reseller', 'admin', NULL, NULL, '', 'Stok Otomatis (Pribadi)', 0, NULL, '2025-05-05 11:14:53', '4', NULL, NULL, NULL, NULL),
(108, 'TRX101.20250505141935', 101, 65, 'konsumen', 'reseller', '156785432', '-', 'COD (Cash on delivery)', 'Dusun Utara', 10000, '14|44|643|Dusun Utara', '2025-05-05 14:19:35', '4', NULL, 1500, '', NULL),
(109, 'TRX102.20250506101500', 102, 65, 'konsumen', 'reseller', '4567', '-', 'COD (Cash on delivery)', 'Dusun Selatan', 20000, '14|44|644|Gunung Bintang Awal', '2025-05-06 10:15:00', '3', NULL, 1500, '', NULL),
(110, 'TRX102.20250507140050', 102, 3, 'konsumen', 'reseller', NULL, '-', 'COD (Cash on delivery)', 'Gunung Bintang Awal', 54300, '14|44|644|Gunung Bintang Awal', '2025-05-07 14:00:50', '2', NULL, 1500, '', NULL),
(111, 'TRX-20250507152432', 65, 1, 'reseller', 'admin', NULL, NULL, '', 'Stok Otomatis (Pribadi)', 0, NULL, '2025-05-07 15:24:32', '4', NULL, NULL, NULL, NULL),
(112, 'TRX-20250507153046', 65, 1, 'reseller', 'admin', NULL, NULL, '', 'Stok Otomatis (Pribadi)', 0, NULL, '2025-05-07 15:30:46', '4', NULL, NULL, NULL, NULL),
(113, 'TRX102.20250508130044', 102, 65, 'konsumen', 'reseller', '9999', '-', '7', 'SOPIR', 31000, '14|44|644|Gunung Bintang Awal', '2025-05-08 13:00:44', '3', NULL, 1500, '', NULL),
(114, 'TRX101.20250508134703', 101, 65, 'konsumen', 'reseller', NULL, '-', '8', 'SOPIR', 3100, '14|44|643|Dusun Utara', '2025-05-08 13:47:03', '1', NULL, 1500, '', NULL),
(115, 'TRX101.20250508135041', 101, 3, 'konsumen', 'reseller', NULL, '-', 'COD (Cash on delivery)', 'Dusun Utara', 25000, '14|44|643|Dusun Utara', '2025-05-08 13:50:41', '1', NULL, 1500, '', NULL),
(116, 'TRX101.20250508152642', 101, 1, 'konsumen', 'reseller', NULL, '-', '', '', 0, '14|44|643|Dusun Utara', '2025-05-08 15:26:42', '2', NULL, 1500, '', NULL);
...
CREATE TABLE `rb_penjualan_detail` (
  ...
  `fee_produk_end` int NOT NULL DEFAULT '0',
...
(112, 105, 25, 1, 0, 2444, 0, NULL, 'Unit', 'Biru; '),
(113, 106, 19, 1, 0, 7860, 0, NULL, 'Unit', 'Hitam; Besar; '),
(114, 107, 78, 50, 0, 0, 0, NULL, '1', NULL),
(115, 108, 78, 1, 0, 89750, 0, NULL, '1', 'Merah; '),
(116, 109, 78, 1, 0, 89750, 0, NULL, '1', 'Merah; '),
(117, 110, 26, 1, 0, 3695, 0, NULL, 'Unit', 'Hitam; '),
(118, 110, 22, 1, 0, 2375, 0, NULL, 'Unit', 'Hitam; '),
(119, 111, 79, 100, 0, 0, 0, NULL, 'Set', NULL),
(120, 112, 80, 100, 0, 0, 0, NULL, 'Paket', NULL),
(121, 113, 79, 3, 0, 21900, 0, NULL, 'Unit', 'Merah; '),
(122, 114, 79, 1, 0, 19899, 0, NULL, 'Unit', 'Hitam; '),
(123, 115, 22, 1, 0, 2375, 0, NULL, 'Unit', 'Hitam; '),
(124, 116, 75, 1, 0, 1000000, 0, NULL, '', '');
...
CREATE TABLE `rb_penjualan_kupon` (
  `id_penjualan_kupon` int NOT NULL,
  `id_penjualan_detail` int NOT NULL,
...
CREATE TABLE `rb_penjualan_otomatis` (
  `id_penjualan_otomatis` int NOT NULL,
  `kode_transaksi` varchar(50) NOT NULL,
  `nominal` int NOT NULL,
...
(4, 'TRX3.20211025113207', 33722, 1, NULL, NULL, NULL, '2021-10-25 11:32:07'),
(5, 'TRX99.20250428145603', 10747, 1, NULL, NULL, NULL, '2025-04-28 14:56:03'),
(6, 'TRX100.20250503143134', 13194, 1, 'fba902a7-87ea-439e-abab-9bf7023a08db', NULL, NULL, '2025-05-03 14:31:34'),
(7, 'TRX101.20250505141935', 102185, 1, NULL, NULL, NULL, '2025-05-05 14:19:35'),
(8, 'TRX102.20250506101500', 111750, NULL, NULL, NULL, NULL, '2025-05-06 10:15:00'),
(9, 'TRX102.20250507140050', 61920, NULL, NULL, NULL, NULL, '2025-05-07 14:00:50'),
(10, 'TRX102.20250508130044', 98244, 1, '73fd1f5f-5575-4410-a00c-b6229468b57f', NULL, NULL, '2025-05-08 13:00:44'),
(11, 'TRX101.20250508134703', 25202, 1, NULL, NULL, NULL, '2025-05-08 13:47:03'),
(12, 'TRX101.20250508135041', 28916, 1, NULL, NULL, NULL, '2025-05-08 13:50:41'),
(13, 'TRX101.20250508152642', 1002142, NULL, NULL, NULL, NULL, '2025-05-08 15:26:42');
...
(24, '20250428105002', 75, 1, 0, 1000000, '', NULL, '', '2025-04-28 10:50:02'),
(26, '99', 25, 1, 0, 2344, 'Unit', NULL, 'Merah; ', '2025-04-30 12:01:33'),
(38, '20250515102825', 79, 1, 0, 21900, 'Unit', NULL, 'Merah; ', '2025-05-15 10:28:25');
...
CREATE TABLE `rb_ppob_margin` (
  `id_ppob_margin` int NOT NULL,
  `id_jenis` int DEFAULT NULL,
  `id_ppob` int NOT NULL,
...
CREATE TABLE `rb_produk` (
  `id_produk` int NOT NULL,
  `id_produk_perusahaan` int NOT NULL,
  `id_kategori_produk` int NOT NULL,
  `id_kategori_produk_sub` int NOT NULL,
  `id_reseller` int NOT NULL,
  ...
  `fee_produk` int NOT NULL DEFAULT '0',
...
(6, 0, 2, 2, 2, 'Pashmina Instan Rafella - RLN1.2 Gold Maroon', 'pashmina-instan-rafella--rln12-gold-maroon', 'unit', 6500, 0, 7500, '130', 'Emily_Grey_grande.jpg', '1. Unrestrained and portable active stereo speaker\r\n2. Free from the confines of wires and chords\r\n3. 20 hours of portable capabilities\r\n4. Double-ended Coil Cord with 3.5mm Stereo Plugs Included\r\n5. 3/4? Dome Tweeters: 2X and 4? Woofer: 1X', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec scelerisque condimentum mattis. Suspendisse potenti. Proin vitae elementum nisi. Aliquam eu pretium risus. Nam varius efficitur consectetur. Aenean vestibulum felis sed mollis faucibus. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin venenatis est sit amet eleifend vehicula. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer id nunc eu odio ultrices pulvinar non feugiat felis. Duis consequat urna sapien, porta gravida diam venenatis at. Duis at ornare enim, ac accumsan eros. Sed in finibus metus. Etiam blandit tristique orci, sit amet congue dui facilisis id. Donec fermentum diam at orci viverra placerat. Sed nunc lorem, cursus nec vestibulum hendrerit, tempus et libero.</p>\r\n\r\n<p>Donec consequat lacinia fringilla. Proin dapibus justo at elit iaculis, eu rutrum velit dapibus. Phasellus nec augue vel nisl sagittis malesuada vel vel orci. In in euismod massa. Praesent vel blandit arcu. Maecenas eleifend dui in est rhoncus, mattis sollicitudin augue semper. Donec a lectus rhoncus, ornare nunc rutrum, egestas arcu. Aenean dapibus urna non nisl dignissim volutpat.</p>', '2', 'Y', 'muslimah,kaos,wanita', 119, 1, NULL, 0, NULL, 'Fisik', NULL, '2017-05-30 06:57:11'),
...
(78, 0, 17, 36, 65, 'Handgrip NOLAN Original HG55 + Jalu Stang CNC + Handle Rem Stelan CNC Handgrip Motor mio aerox nmax fino soul xeon mio m3 fazzio', 'handgrip-nolan-original-hg55--jalu-stang-cnc--handle-rem-stelan-cnc-handgrip-motor-mio-aerox-nmax-fino-soul-xeon-mio-m3-fazzio-111453', '1', 87500, 0, 89750, '30', 'id-11134207-7r990-lxea2khcunbh76_tn.jpg;nolan-blue.jpg;nolan-red.jpg;nolan-silver.jpg', 'Handgrip NOLAN Original HG55', '<p>Handgrip NOLAN Original HG55 + Jalu Stang CNC + Handle Rem Stelan CNC Handgrip Motor mio aerox nmax fino soul xeon mio m3 fazzio<br></p>', '65', 'Y', 'aksesoris-motor', 2, 1, 'HG55 ', 0, NULL, 'Fisik', NULL, '2025-05-05 11:14:53'),
(79, 0, 17, 0, 65, 'JALU AS DEPAN-AKSESORIS-VARIASI MOTOR JALU AS RODA DEPAN ROBOT JUMBO - Biru, All size motor', 'jalu-as-depanaksesorisvariasi-motor-jalu-as-roda-depan-robot-jumbo--biru-all-size-motor-152432', 'Unit', 15000, 0, 19900, '2', 'fda77b56-64ba-41dd-9c11-58b130805946.jpg;eb67cdc3-4e64-442f-a483-22523da991f5.jpg;jalu-silver.jpg;jalu-blue.jpg', '    Kondisi: Baru\r\n    Min. Pemesanan: 1 Buah', '<span class=\"css-11oczh8 eytdjj00\"><span class=\"css-17zm3l eytdjj01\"><div data-testid=\"lblPDPDescriptionProduk\">JALU AS RODA DEPAN VARIASI<br><br>UKURAN JUMBO BESAR<br>BAHAN ALM CNC CAMPURAN ABS<br><br>MODEL ROBOT KOKOH DAN ELEGAN<br><br>PNP PEMASANGAN SEMUA JENIS MOTOR</div></span></span><p></p>', '65', 'Y', 'aksesoris-motor', 3, 1, '', 0, NULL, 'Fisik', NULL, '2025-05-07 15:24:32'),
(80, 0, 17, 0, 65, 'PAKET HANDGRIP GRIP HANFAT SARUNG GAS OCTAGON PLUS JALU BANDUL STANG SPIRAL MODEL HENG CHROME UNIVERSAL SEMUA MOTOR - GRIP OCTAGON+JALU SPIRAL', 'paket-handgrip-grip-hanfat-sarung-gas-octagon-plus-jalu-bandul-stang-spiral-model-heng-chrome-universal-semua-motor--grip-octagonjalu-spiral-153046', 'Paket', 20000, 0, 26000, '5', 'hand-grip.jpg', '', '<p><span class=\"css-11oczh8 eytdjj00\"><span class=\"css-17zm3l eytdjj01\">Ready stok barang sesuai difoto iklan<br>Barang yang diorder pasti akan dikirim sesuai yang dipesan,kecuali stok kosong akan kita konfirmasi.<br>SEBELUM MEMESAN DISARANKAN UNTUK MENANYAKAN STOK..!!!</span></span></p>', NULL, 'Y', 'aksesoris-motor', 3, 1, '', 0, NULL, 'Fisik', NULL, '2025-05-07 15:30:46');
...
CREATE TABLE `rb_produk_group` (
  ...
  `id_produk` int NOT NULL,
  `jumlah_group` int NOT NULL,
  `harga_group` int NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `rb_produk_penawaran` (
  `id_produk_penawaran` int NOT NULL,
  `id_produk` int NOT NULL,
  `waktu_input` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
(194, 3, 'Ukuran', 'Pendek;Medium;Dalam', '200;100;400'),
(193, 3, 'Warna', 'Biru;Coklat', '125;135'),
(178, 19, 'Ukuran', 'Medium;Besar', '125;135'),
...
(268, 4, 'Ukuran', 'Medium;Dalam', '50;40'),
...
(180, 17, 'Ukuran', 'Pendek;Medium', '125;850'),
...
(289, 78, 'Warna', 'Merah;Bitu;Silver;Hitam', '0;0;0;0'),
(291, 79, 'Warna', 'Merah;Bitu;Silver;Hitam', '2000;2000;2000;-1');
...
(1, 'Bank BNI Syariah', '0817 0242 31', 'UMKM Barsel', 'bni.jpg'),
(2, 'Bank Mandiri Syariah', '7128 5288 67', 'UMKM Barsel', 'mandiri.gif'),
(4, 'Bank BRI Syariah', '1043 5665 19', 'UMKM Barsel', 'bri.jpg');
...
INSERT INTO `rb_rekening_reseller` (`id_rekening_reseller`, `id_reseller`, `nama_bank`, `no_rekening`, `pemilik_rekening`, `gambar`) VALUES
(1, 1, 'Bank Danamon', '56234234000', 'Umar', ''),
(2, 2, 'Bank BCA', '10823422', 'Syarii Sentral', ''),
(3, 3, 'Bank Mandiri', '234123123332', 'Kalifah Umayyah', 'mandiri.gif'),
(4, 65, 'Mandiri', '1327654389', 'Vargas', 'mandiri.gif'),
(5, 1, 'bank testing', 'rekening testing', 'fadli dwi', '');
...
CREATE TABLE `rb_reseller` (
  ...
  `norek_bank` varchar(30) NOT NULL,
...
INSERT INTO `rb_reseller` (`id_reseller`, `id_konsumen`, `user_reseller`, `nama_reseller`, `kecamatan_id`, `kota_id`, `provinsi_id`, `alamat_lengkap`, `no_telpon`, `nama_bank`, `norek_bank`, `an_bank`, `keterangan`, `pilihan_kurir`, `foto`, `referral`, `tanggal_daftar`, `verifikasi`, `kordinat`) VALUES
(1, 1, 'umar-lapakers', 'Umar Lapakers', 646, 44, 14, 'Jl. Angkasa Pura Raya, No 456 BG', '681267771355', '', '0', '', 'Kami merupakan perusahaan yang bergerak dalam bidang kecantikan. Produk yang kami hasilkan secara ilmiah terbukti bermanfaat.  Harapan perusahaan kami adalah, menciptakan produk kecantikan produksi Indonesia yang berstandar internasional.', '1,3,5,6,7', 'phpmu.png', 2, '2017-05-23 06:14:19', 'Y', '-0.31647759679001236, 100.38398020608086'),
(2, 2, 'syarii-sentral-java', 'Syarii Sentral Java', 646, 44, 14, 'Jl. Ulak Karang Raya, No 165', '681267771344', '', '0', '', 'Kami merupakan perusahaan yang bergerak dalam bidang kecantikan. Produk yang kami hasilkan secara ilmiah terbukti bermanfaat.  Harapan perusahaan kami adalah, menciptakan produk kecantikan produksi Indonesia yang berstandar internasional.', '1,3,5,7', NULL, 0, '2017-05-23 05:09:11', 'Y', NULL),
(3, 3, 'kalifah-umayyah', 'Kalifah Umayyah', 645, 44, 14, 'Jl. Tiaka Raya, No 678', '681267771344', '', '0', '', 'Kami merupakan perusahaan yang bergerak dalam bidang kecantikan. Produk yang kami hasilkan secara ilmiah terbukti bermanfaat.  Harapan perusahaan kami adalah, menciptakan produk kecantikan produksi Indonesia yang berstandar internasional.', '', 'avatar2.png', 0, '2017-05-28 11:13:13', 'Y', '-0.32609048275399355, 100.39640231092439'),
(5, 5, 'toko-koko', 'Toko Koko', 3939, 280, 8, 'Jl. Sitinjau Laiuk Lauih Mandiangin', '081268881888', '', '0', '', 'Apakah Anda mencari gambar Eceran, Ikon Komputer, E Commerce png? Jelajahi koleksi gambar png Eceran, Ikon Komputer, E Commerce kami yang luar biasa. Di bagian ini, Anda akan menemukan ratusan Eceran, Ikon Komputer, E Commerce gambar transparan, ikon, vektor, dan banyak lainnya. Koleksi gambar Eceran, Ikon Komputer, E Commerce png kami meliputi, Array dan lainnya. Gambar baru diunggah setiap minggu. Klik pada gambar thumbail untuk mengunduh gambar ukuran penuh.', NULL, NULL, NULL, '2020-10-01 11:20:01', 'N', NULL),
(35, 16, 'delingart', 'delingart', 2924, 209, 10, 'Getas Pejaten, Jati, Kudus', '085292456800', '', '0', '', 'Menjual Berbagai Kerajinan dari Kayu Bambu', NULL, NULL, NULL, '2020-10-02 11:20:06', 'N', NULL),
(36, 18, 'toko-iwak-pithik', 'Toko iwak pithik', 5496, 398, 10, 'Jalan yos sudarso no 44 ungaran', '085641172888', '', '0', '', 'Toko iwak dan pithik', NULL, '030EBF7C-CE14-40CF-8463-F0329D51F59C.jpeg', NULL, '2020-10-03 11:20:10', 'N', NULL),
(38, 27, 'toko-aa', 'Toko AA', 1470, 107, 9, 'aaa', '88888', '', '0', '', 'aa', NULL, 'Desert.jpg', NULL, '2020-10-05 11:20:17', 'N', NULL),
(39, 29, 'toko-madu-dan-herbal-alami', 'Toko Madu dan Herbal Alami', 5634, 409, 11, 'Jl. Baladewa 20, Girya Permata Gedangan', '081357657007', '', '0', '', 'Kami menjual madu berkualitas dan herbal alami', NULL, NULL, NULL, '2020-10-06 11:20:20', 'N', NULL),
(40, 32, 'tokolami', 'Tokolami', 1788, 129, 7, 'Gorontalo', '08124519238', '', '0', '', 'Okey', NULL, NULL, NULL, '2020-10-07 11:20:24', 'N', NULL),
(41, 36, 'logistic-shop', 'Logistic Shop', 2109, 153, 6, 'Ampera', '08995152693', '', '0', '', 'Logistic Shop', NULL, 'Logistic.jpg', NULL, '2020-10-08 11:20:27', 'N', NULL),
(45, 48, 'kerupuk-husna', 'Kerupuk husna', 3878, 276, 22, 'Jalan Raden mas Panji Anom pagutan timur Krg buaya no 13', '087865722652', '', '0', '', 'Kerupuk sapi', '1,2,3', NULL, NULL, '2020-10-11 11:20:36', 'N', NULL),
(51, 54, 'toko-hendriyanto1234', 'Toko hendriyanto1234', 3301, 232, 3, 'sfasdsadasd', '45234234234', '', '0', '', 'dsfsdfsdf', '5,7', NULL, NULL, '2020-10-15 11:20:53', 'N', NULL),
(52, 63, 'anzhana-store', 'Anzhana Store', 2511, 178, 11, 'Jl. Pamenang II/42 Katang Sukorejo', '081331390003', '', '0', '', 'Toko Sembako', '1,2,5', NULL, NULL, '2021-02-10 12:34:55', 'N', NULL),
(53, 65, 'test', 'Test', 700, 50, 8, 'Jl Test', 'Test', '', '0', '', 'Tet', '4', NULL, NULL, '2021-02-10 15:24:10', 'N', NULL),
(54, 67, 'fghfghfgh', 'fghfghfgh', 434, 28, 2, 'hfgh', 'fghf', '', '0', '', 'fghfgh', '1,2,3,4,7', NULL, NULL, '2021-02-11 07:12:52', 'N', NULL),
(55, 75, 'nelly-shop', 'Nelly Shop', 644, 44, 14, 'Jalan Majapahit, Perumahan Cempaka Indah No. 3E, Gunung Bintang Awai, Barito Selatan', '085936144442', '', '0', '', 'Shopping From Home and Anytime', '1,2,5', 'WhatsApp_Image_2021-08-19_at_16_55_42.jpeg', 0, '2021-08-19 16:01:23', 'Y', NULL),
(56, 83, 'nyai-dillustartion', 'Nyai D.ILLUSTRATION', 643, 44, 14, 'BTN SANGGULAN block 33 D no 15', '0895623337211', '', '0', '', 'Do you need design or potrait of your self ? Just hire me and i wall make it for you. Just Rp 50.000 - Rp 160.000 Order now!', '', 'Tak_berjudul22_20210530221722.png', 0, '2021-08-20 14:55:12', 'Y', NULL),
(57, 88, 'dm_store', 'DM_STORE', 642, 44, 14, 'Jalan Kresna, Perum Griya Asri, Dusun Selatan, Barito Selatan', '081803343050', '', '0', '', 'Menjual berbagai barang murah meriah', '1,2,4,6,8,12,13', NULL, 0, '2021-08-20 15:42:46', 'Y', NULL),
(58, 87, 'jinhit_food', 'JINHIT_FOOD', 641, 44, 14, 'Jln. Btn asri persada pesiapan, Dusun Hilir', '087752897578', '', '0', '', 'Menjual berbagai makanan lauk pauk, ayam geprek, jajanan donat, dan nasi kuning dijamin enak rasanya, dengan harga yang murah terjangkau. Silahkan hubungi dan order hanya di JINHIT_FOOD terimakasih.', '1,2', NULL, 0, '2021-08-20 16:07:10', 'Y', NULL),
(59, 86, 'jn_store', 'JN_STORE', 646, 44, 14, 'Jl Pulau Menjangan No 40 Dauh Pala - Karau Kuala, Barito Selatan', '085739284414', '', '0', '', 'Menjual berbagai barang murah', '1,2', NULL, 0, '2021-08-20 16:23:12', 'Y', NULL),
(60, 89, 'putri_store', 'Putri_Store', 645, 44, 14, 'Desa Megati,Banjar dinas Megati Kaja, Selemadeg timur, Tabanan,Bali', '085739284143', '', '0', '', 'Menjual berbagai barang  murah dan mudah terjangkau. silahkan order di (Putri_Store) terimakasih. ', '1,2,6', NULL, 0, '2021-08-20 16:24:39', 'Y', NULL),
(61, 91, 'listyadshop', 'listyadshop', 644, 44, 14, 'Br. Jebaud, Desa Beringkit Belayu, Kec. Gunung Bintang Awai, Kab. Barito Selatan', '081913665912', '', '0', '', 'Menjual fashion wanita', '1,2,5', NULL, 0, '2021-08-20 18:46:26', 'Y', NULL),
(62, 85, 'bt_store', 'BT_STORE', 643, 44, 14, 'Jln. Kamboja GG IIB No. 2 Dusun Utara', '081246602599', '', '0', '', 'Menjual berbagai jenis case hp dengan harga murah dan mudah terjangkau. silahkan order di BT_STORE terimakasih.', '1,2', NULL, 0, '2021-08-20 18:47:19', 'Y', NULL),
(63, 92, 'gekliashop', 'Gekliashop', 642, 44, 14, 'Jalan mawar no. 96, Dusun Selatan', '', '', '0', '', 'Menjual aksesoris dan perhiasan wanita', '1,2,3', NULL, 0, '2021-08-20 19:19:33', 'Y', NULL),
(64, 94, 'lakuaja', 'Lakuaja', 641, 44, 14, 'Kota Harapan Indah, Cluster Harmoni, Hz 3 No. 7, Dusun Hilir', '081219639996', '', '0', '', 'Hai, Selamat datang di toko Lakuaja, toko kami menjual perlengkapan sholat', '1,3', NULL, 0, '2021-08-21 22:53:51', 'Y', NULL),
(65, 99, 'toko-variasi', 'Toko Variasi', 643, 44, 14, 'Dusun Utara', '08123456789', 'Mandiri', '1327654389', 'Vargas', 'Menjual Variasi Motor', '', NULL, 0, '2025-05-05 10:53:00', 'Y', '-1.7227957041890332, 114.84284394528686'),
(66, 104, 'toko-testing', 'toko testing', 641, 44, 14, 'alamat testing', '0812345678910', 'bank testing', 'rekening testing', 'fadli dwi', 'keterangan testing', '', NULL, NULL, '2025-09-16 13:05:33', 'Y', '-1.719022375778727, 114.84544701936868');
...
(7, 3, 'Gunung Bintang Awal', 54300),
(8, 3, 'Dusun Hilir', 20000),
(9, 3, 'Dusun Utara', 25000),
(10, 3, 'Dusun Selatan', 25000),
(11, 2, 'Aur Birugo, Bukittinggi', 0),
(12, 65, 'Dusun Hilir', 15000),
(13, 65, 'Dusun Utara', 10000),
(14, 65, 'Dusun Selatan', 20000),
(15, 65, 'Gunung Bintang Awal', 25000),
(16, 65, 'Jenamas', 10000),
(17, 65, 'Karau Kuala', 45000);
...
CREATE TABLE `rb_reseller_paket` (
  `id_reseller_paket` int NOT NULL,
  `id_paket` int NOT NULL,
  `id_reseller` int NOT NULL,
...
(11, 3, 66, 'N', NULL, 999011, '0', '2025-09-16', '2025-09-16 13:31:15');
...
(1, 3, 646, 44, 14, 1, 'KH 3456 D', 'Mio Sporty', '', '', 'Y'),
(2, 5, 645, 44, 14, 1, 'KH 4665 D', 'Vixion R', '', '', 'Y'),
(3, 7, 646, 44, 14, 2, 'KH 7876 D', 'Toyota Avanza', '', '', 'Y'),
(4, 11, 645, 44, 14, 1, 'KH 4344 D', 'Tiger 2019', '', '', 'Y'),
(6, 39, 644, 44, 14, 2, 'F 1010 GH', 'honda bet', '', '', 'Y'),
(7, 1, 643, 44, 14, 1, 'BA 4344 CJ', 'Tiger 2019', '', '', 'Y'),
(8, 2, 643, 44, 14, 1, 'BA 2354 LN', 'N-MAX 2019', 'Pastikan data profil sesuai dengan KTP untuk kemudahan dalam bertransaksi.', 'persyaratan.jpg', 'Y'),
(9, 99, 645, 44, 14, 1, 'KH 1234 D', 'KTM Duke 400', 'Dusun Hilir, Dusun Utara, Dusun Selatan, Gunung Bintang Awal, Jenamas, Karau Kuala', 'footer_working_hour_icon.png', 'Y');
...
('36.72.214.218', '2024-08-27', 41, '1724758502'),
('182.4.100.156', '2024-08-27', 12, '1724768035'),
('36.73.112.109', '2024-08-28', 1, '1724832049'),
('36.80.233.126', '2024-09-02', 1, '1725216576'),
('36.80.233.126', '2024-09-04', 1, '1725385460'),
('36.73.49.19', '2024-09-08', 1, '1725765350'),
('125.160.107.186', '2024-09-08', 1, '1725813876'),
('36.72.213.150', '2024-09-09', 1, '1725836890'),
('125.160.100.37', '2024-09-10', 1, '1725961561'),
('180.246.127.100', '2024-10-02', 1, '1727849953'),
('36.78.39.173', '2024-10-15', 1, '1728969215'),
('36.73.122.115', '2024-10-24', 1, '1729766105'),
('36.73.46.227', '2024-12-03', 2, '1733209158'),
('36.80.225.128', '2025-03-06', 2, '1741256889'),
('125.160.106.184', '2025-03-21', 1, '1742541133'),
('182.4.103.136', '2025-04-14', 1, '1744619134'),
('36.81.71.217', '2025-04-14', 15, '1744620500'),
('36.81.71.217', '2025-04-15', 13, '1744707966'),
('36.81.48.229', '2025-04-28', 74, '1745829171'),
('36.81.48.229', '2025-04-29', 26, '1745917332'),
('180.254.108.91', '2025-04-30', 64, '1745996383'),
('36.72.217.217', '2025-05-02', 6, '1746174545'),
('36.72.217.217', '2025-05-03', 28, '1746259314'),
('36.72.217.217', '2025-05-05', 91, '1746435243'),
('125.165.211.204', '2025-05-06', 28, '1746525038'),
('36.80.220.75', '2025-05-07', 140, '1746606696'),
('36.72.214.209', '2025-05-07', 2, '1746599108'),
('36.80.220.75', '2025-05-08', 183, '1746693040'),
('103.189.123.5', '2025-05-08', 1, '1746686454'),
('36.72.214.209', '2025-05-08', 1, '1746687124'),
('182.4.70.159', '2025-05-09', 1, '1746734013'),
('36.72.214.209', '2025-05-09', 1, '1746754913'),
('36.80.220.75', '2025-05-09', 1, '1746760886'),
('36.80.236.196', '2025-05-10', 1, '1746842264'),
('118.96.177.67', '2025-05-15', 6, '1747279709'),
('36.80.216.255', '2025-06-07', 1, '1749282217'),
('36.78.33.132', '2025-06-23', 1, '1750655819'),
('36.73.42.199', '2025-06-30', 1, '1751277044'),
('36.72.214.76', '2025-07-02', 1, '1751429509'),
('36.72.214.203', '2025-07-02', 84, '1751434800'),
('103.106.216.68', '2025-07-02', 1, '1751433591'),
('150.129.59.5', '2025-07-02', 1, '1751433592'),
('103.106.216.69', '2025-07-02', 1, '1751434485'),
('103.189.123.4', '2025-07-02', 1, '1751434489'),
('103.26.211.5', '2025-07-02', 1, '1751434799'),
('118.97.217.130', '2025-07-02', 1, '1751442158'),
('36.72.214.203', '2025-07-03', 7, '1751514560'),
('118.97.217.130', '2025-07-07', 4, '1751851232'),
('180.254.139.16', '2025-07-17', 1, '1752745957'),
('36.80.231.165', '2025-07-21', 2, '1753083054'),
('182.253.58.240', '2025-07-24', 2, '1753322680'),
('182.8.227.237', '2025-07-30', 2, '1753859050'),
('182.8.225.8', '2025-07-30', 1, '1753870914'),
('182.8.226.181', '2025-08-12', 1, '1754956072'),
('202.152.54.130', '2025-08-12', 6, '1754990776'),
('103.113.78.18', '2025-08-12', 4, '1754991009'),
('114.10.78.188', '2025-08-12', 1, '1754992053'),
('182.8.226.181', '2025-08-14', 1, '1755189903'),
('182.8.225.14', '2025-08-19', 3, '1755568611'),
('182.8.226.76', '2025-08-20', 3, '1755677808'),
('182.8.225.20', '2025-08-23', 5, '1755911991'),
('202.152.54.130', '2025-08-25', 1, '1756094119'),
('182.8.225.20', '2025-08-26', 3, '1756217079'),
('182.4.100.47', '2025-08-29', 1, '1756435619'),
('182.4.100.183', '2025-08-29', 1, '1756442258'),
('125.164.99.22', '2025-08-29', 7, '1756452946'),
('77.111.246.27', '2025-08-30', 1, '1756527343'),
('182.8.225.51', '2025-09-02', 1, '1756796349'),
('127.0.0.1', '2025-09-16', 107, '1758013182'),
('::1', '2025-09-16', 32, '1758011369'),
('127.0.0.1', '2025-09-17', 92, '1758114812'),
('127.0.0.1', '2025-09-18', 113, '1758184561'),
('127.0.0.1', '2025-09-20', 49, '1758341716'),
('127.0.0.1', '2025-09-20', 49, '1758341716'),
('::1', '2025-09-20', 2, '1758342346'),
('127.0.0.1', '2025-09-23', 83, '1758617253'),
('127.0.0.1', '2025-09-25', 75, '1758785940'),
('::1', '2025-09-25', 31, '1758779673'),
('127.0.0.1', '2025-09-30', 21, '1759214057'),
('::1', '2025-09-30', 37, '1759213938'),
('127.0.0.1', '2025-10-02', 5, '1759389032'),
('127.0.0.1', '2025-10-04', 7, '1759547103'),
('::1', '2025-10-07', 3, '1759803681'),
('127.0.0.1', '2025-10-07', 26, '1759807066'),
('127.0.0.1', '2025-10-11', 14, '1760167460'),
('127.0.0.1', '2025-10-14', 17, '1760415015'),
('127.0.0.1', '2025-10-15', 23, '1760544833'),
('127.0.0.1', '2025-10-16', 52, '1760595544'),
('::1', '2025-10-16', 4, '1760579016'),
('127.0.0.1', '2025-10-25', 54, '1761376133'),
('127.0.0.1', '2025-10-30', 84, '1761793955'),
('127.0.0.1', '2025-11-04', 82, '1762235343'),
...
(1, 'Pria', 'admin', 'pria', 73),
(2, 'Wanita', 'admin', 'wanita', 492),
(3, 'Kaos', 'admin', 'kaos', 484),
(4, 'Kemeja', 'admin', 'kemeja', 43),
(5, 'Sepatu', 'admin', 'sepatu', 0),
(6, 'Jam Tangan', 'admin', 'jam-tangan', 0),
(7, 'Makanan', 'admin', 'makanan', 0),
(8, 'Minuman', 'admin', 'minuman', 0),
(9, 'Elektronik', 'admin', 'elektronik', 60),
(10, 'Laptop', 'admin', 'laptop', 66),
(11, 'Komputer', 'admin', 'komputer', 38),
(12, 'Tas Jinjing', 'admin', 'tas-jinjing', 2),
(13, 'Hardware', 'admin', 'hardware', 60),
(14, 'Software', 'admin', 'software', 73),
(15, 'Jeans', 'admin', 'jeans', 74),
(16, 'Muslimah', 'admin', 'muslimah', 469),
(17, 'Aksesoris Motor', 'admin', 'aksesoris-motor', 8);
...
INSERT INTO `tb_ro_provinces` (`province_id`, `province_name`, `province_aktif`) VALUES
(1, 'Bali', 0),
(2, 'Bangka Belitung', 0),
(3, 'Banten', 0),
(4, 'Bengkulu', 0),
...
('admin', '21232f297a57a5a743894a0e4a801fc3', 'Administrator', 'admin.techno@gmail.com', '081267771344', 'avatar51.png', 'admin', 'N', 'q173s8hs1jl04st35169ccl8o7'),
...
(15, '6643bc44d7dc56b243a5e3b5eb4c578f-20250507144852', 10);
...
--
ALTER TABLE `agenda`
  MODIFY `id_agenda` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `album`
--
ALTER TABLE `album`
  MODIFY `id_album` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `banner`
  MODIFY `id_banner` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `berita`
--
ALTER TABLE `berita`
  MODIFY `id_berita` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=686;
...
--
ALTER TABLE `download`
  MODIFY `id_download` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `gallery`
--
ALTER TABLE `gallery`
  MODIFY `id_gallery` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=255;

--
-- AUTO_INCREMENT for table `halamanstatis`
--
ALTER TABLE `halamanstatis`
  MODIFY `id_halaman` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `hubungi`
  MODIFY `id_hubungi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `iklanatas`
  MODIFY `id_iklanatas` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `iklantengah`
--
ALTER TABLE `iklantengah`
  MODIFY `id_iklantengah` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `katajelek`
  MODIFY `id_jelek` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `kategori`
--
ALTER TABLE `kategori`
  MODIFY `id_kategori` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `kategori_banner`
--
ALTER TABLE `kategori_banner`
  MODIFY `id_kategori_banner` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `kategori_topic`
--
ALTER TABLE `kategori_topic`
  MODIFY `id_kategori_topic` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `komentar`
--
ALTER TABLE `komentar`
  MODIFY `id_komentar` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166;

--
-- AUTO_INCREMENT for table `komentarvid`
--
ALTER TABLE `komentarvid`
  MODIFY `id_komentar` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;

--
-- AUTO_INCREMENT for table `logo`
--
ALTER TABLE `logo`
  MODIFY `id_logo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `menu`
--
ALTER TABLE `menu`
  MODIFY `id_menu` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;
...
--
ALTER TABLE `pasangiklan`
  MODIFY `id_pasangiklan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `poling`
  MODIFY `id_poling` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `rb_bonus`
  MODIFY `id_bonus` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `rb_donasi`
  MODIFY `id_donasi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `rb_driver_ongkir`
--
ALTER TABLE `rb_driver_ongkir`
  MODIFY `id_driver_ongkir` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `rb_jenis_kendaraan`
--
ALTER TABLE `rb_jenis_kendaraan`
  MODIFY `id_jenis_kendaraan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `rb_kategori_produk`
--
ALTER TABLE `rb_kategori_produk`
  MODIFY `id_kategori_produk` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `rb_kategori_produk_sub`
--
ALTER TABLE `rb_kategori_produk_sub`
  MODIFY `id_kategori_produk_sub` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `rb_keterangan`
--
ALTER TABLE `rb_keterangan`
  MODIFY `id_keterangan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `rb_konfirmasi_pembayaran`
--
ALTER TABLE `rb_konfirmasi_pembayaran`
  MODIFY `id_konfirmasi_pembayaran` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `rb_konfirmasi_pembayaran_konsumen`
--
ALTER TABLE `rb_konfirmasi_pembayaran_konsumen`
  MODIFY `id_konfirmasi_pembayaran` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `rb_konsumen`
--
ALTER TABLE `rb_konsumen`
  MODIFY `id_konsumen` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;

--
-- AUTO_INCREMENT for table `rb_konsumen_alamat`
--
ALTER TABLE `rb_konsumen_alamat`
  MODIFY `id_konsumen_alamat` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `rb_konsumen_detail`
--
ALTER TABLE `rb_konsumen_detail`
  MODIFY `id_konsumen_detail` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `rb_konsumen_simpan`
--
ALTER TABLE `rb_konsumen_simpan`
  MODIFY `id_konsumen_simpan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `rb_konsumen_verifikasi`
--
ALTER TABLE `rb_konsumen_verifikasi`
  MODIFY `id_verifikasi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `rb_kota`
--
ALTER TABLE `rb_kota`
  MODIFY `kota_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=502;

--
-- AUTO_INCREMENT for table `rb_kurir`
--
ALTER TABLE `rb_kurir`
  MODIFY `id_kurir` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `rb_pembayaran_bonus`
  MODIFY `id_pembayaran_bonus` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rb_pembelian`
--
ALTER TABLE `rb_pembelian`
  MODIFY `id_pembelian` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `rb_pembelian_detail`
--
ALTER TABLE `rb_pembelian_detail`
  MODIFY `id_pembelian_detail` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `rb_pembelian_pulsa`
--
ALTER TABLE `rb_pembelian_pulsa`
  MODIFY `id_pembelian_pulsa` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rb_pencairan_bonus`
--
ALTER TABLE `rb_pencairan_bonus`
  MODIFY `id_pencairan_bonus` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rb_pencairan_reward`
--
ALTER TABLE `rb_pencairan_reward`
  MODIFY `id_pencairan_reward` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rb_penjualan`
--
ALTER TABLE `rb_penjualan`
  MODIFY `id_penjualan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;

--
-- AUTO_INCREMENT for table `rb_penjualan_detail`
--
ALTER TABLE `rb_penjualan_detail`
  MODIFY `id_penjualan_detail` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT for table `rb_penjualan_kupon`
--
ALTER TABLE `rb_penjualan_kupon`
  MODIFY `id_penjualan_kupon` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rb_penjualan_otomatis`
--
ALTER TABLE `rb_penjualan_otomatis`
  MODIFY `id_penjualan_otomatis` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `rb_penjualan_temp`
--
ALTER TABLE `rb_penjualan_temp`
  MODIFY `id_penjualan_detail` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `rb_ppob_margin`
--
ALTER TABLE `rb_ppob_margin`
  MODIFY `id_ppob_margin` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `rb_produk`
--
ALTER TABLE `rb_produk`
  MODIFY `id_produk` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;

--
-- AUTO_INCREMENT for table `rb_produk_diskon`
--
ALTER TABLE `rb_produk_diskon`
  MODIFY `id_produk_diskon` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `rb_produk_kupon`
  MODIFY `id_kupon` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `rb_produk_penawaran`
--
ALTER TABLE `rb_produk_penawaran`
  MODIFY `id_produk_penawaran` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `rb_produk_variasi`
  MODIFY `id_variasi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=292;

--
-- AUTO_INCREMENT for table `rb_provinsi`
--
ALTER TABLE `rb_provinsi`
  MODIFY `provinsi_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `rb_pusat_bantuan`
--
ALTER TABLE `rb_pusat_bantuan`
  MODIFY `id_pusat_bantuan` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `rb_pusat_bantuan_diskusi`
--
ALTER TABLE `rb_pusat_bantuan_diskusi`
  MODIFY `id_diskusi` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `rb_rekening_reseller`
  MODIFY `id_rekening_reseller` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `rb_reseller`
--
ALTER TABLE `rb_reseller`
  MODIFY `id_reseller` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT for table `rb_reseller_cod`
--
ALTER TABLE `rb_reseller_cod`
  MODIFY `id_cod` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `rb_reseller_paket`
--
ALTER TABLE `rb_reseller_paket`
  MODIFY `id_reseller_paket` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `rb_sopir`
  MODIFY `id_sopir` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `rb_subscribe`
--
ALTER TABLE `rb_subscribe`
  MODIFY `id_subscribe` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `rb_withdraw`
  MODIFY `id_withdraw` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sekilasinfo`
--
ALTER TABLE `sekilasinfo`
  MODIFY `id_sekilas` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tag`
  MODIFY `id_tag` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT for table `tagpro`
--
ALTER TABLE `tagpro`
  MODIFY `id_tag` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tagvid`
--
ALTER TABLE `tagvid`
  MODIFY `id_tag` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `tbl_comment`
--
ALTER TABLE `tbl_comment`
  MODIFY `id_komentar` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `topic`
  MODIFY `id_topic` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `users_modul`
--
ALTER TABLE `users_modul`
  MODIFY `id_umod` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `video`
--
ALTER TABLE `video`
  MODIFY `id_video` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;
COMMIT;
